...
export default function HomeBannerButoon({children,className}:{children:React.ReactNode,className:string}) {

    return <div className={`card-wrapper ${className} group w-fit h-fit text-sm font-sans overflow-hidden relative rounded-full p-[1.2px]  bg-black dark:bg-neutral-600 text-white`}>
