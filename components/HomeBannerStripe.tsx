            ...
            <main className="relative container mx-auto  mt-20 z-1">
                <div className="w-full flex flex-col items-center justify-center pt-24">
                    ...
                    <div className="text-center  w-3/4 pt-6 font-sans ">
                        <h1 className="text-4xl  font-extrabold text-black dark:text-white">Transform policy analysis with AI for brokers</h1>
                        <p className="text-sm font-medium  px-5 lg:px-16 pt-4  dark:text-white/80">Save 15 hours every week, minimize errors and omissions exposure, and experience measurable ROI within 3 weeks — all powered by compliant, broker-friendly AI solutions.</p>
                    </div>
